<template>
  <div class="item2-container">
    <div v-for="item in items" :key="item.id" class="item2-box">
      <div class="item2">
        <div class="item2-up">
          <div style="font-size: 1rem; font-weight: 400; margin-bottom: 0.3rem">
            {{ item.name }}
          </div>
          <div
      ...
      <img class="item2img" :src="require(`~/static/${item.image}.jpg`)" />
    </div>
  </div>
</template>
